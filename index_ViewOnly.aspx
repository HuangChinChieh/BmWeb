...
<%
    ...
    if (CodingControl.FormSubmit())
    {
                ...
                if ((LoginPassword != string.Empty) && (LoginPassword != null))
                {
                    if ((ImageCode != string.Empty) && (ImageCode != null))
                    {
                        ...
                        if (Ret.ResultState == EWin.Login.enumResultState.OK)
                        {
                            ...
                            Response.Redirect(EWinWeb.EWinUrl + "/ViewOnly/Login.aspx?CT=" + Server.UrlEncode(CT) + "&Lang=" + Lang + "&Action=Game");
        ...
        else
        {
            ...
            if ((ImageCode != string.Empty) && (ImageCode != null))
            {
                Response.Redirect(EWinWeb.EWinUrl + "/ViewOnly/LoginGuest.aspx?Lang=" + Lang + "&LoginGUID=" + LoginGUID + "&ImageCode=" + ImageCode + "&Action=Game");
                    ...
                    <form method="post">
                        ...
                        <div id="loginDiv" class="form">
                            <fieldset>
                                ...
                                <button style="display:none" class="btn" type="button" value="Register" onclick="window.location.href='register.aspx'">
